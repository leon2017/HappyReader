...
public class DaoMaster extends AbstractDaoMaster {
    ...
    public static void createAllTables(SQLiteDatabase db, boolean ifNotExists) {
        WeekForeCastDao.createTable(db, ifNotExists);
        RealWeatherDao.createTable(db, ifNotExists);
        HourForeCastDao.createTable(db, ifNotExists);
        AqiDao.createTable(db, ifNotExists);
        ZhishuDao.createTable(db, ifNotExists);
        UseAreaDao.createTable(db, ifNotExists);
    ...
    public DaoMaster(SQLiteDatabase db) {
        ...
        registerDaoClass(WeekForeCastDao.class);
        registerDaoClass(RealWeatherDao.class);
        registerDaoClass(HourForeCastDao.class);
        registerDaoClass(AqiDao.class);
        registerDaoClass(ZhishuDao.class);
        registerDaoClass(UseAreaDao.class);
