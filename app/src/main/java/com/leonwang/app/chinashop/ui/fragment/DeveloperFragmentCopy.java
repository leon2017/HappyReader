...
public class DeveloperFragmentCopy extends RxLazyBaseFragment {
    ...
    public static DeveloperFragmentCopy newInstance(String param4) {
        DeveloperFragmentCopy developerFragment = new DeveloperFragmentCopy();
...
//        int type = getIntent().getIntExtra("from", 0);
        ...
        mButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (mButton.getText().toString().equals("开始定位") ){
    ...
    private boolean addPermission(ArrayList<String> permissionsList, String permission) {
        if (getApplicationContext().checkSelfPermission(permission) != PackageManager.PERMISSION_GRANTED) { // 如果应用没有获得对应权限,则添加到列表中,准备批量申请
